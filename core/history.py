...
def history_item_from_manifest(report_dir: Path, manifest: dict[str, Any]) -> dict[str, Any]:
    ...
    item = {
        ...
        "files": {
            ...
            "weibo_body": _file_exists(report_dir, files.get("weibo_body")),
            "images": _dir_exists(report_dir, files.get("images") or files.get("images_dir")),
            "image_report": _file_exists(report_dir, files.get("image_report_preview")) or _docx_exists(report_dir, files.get("image_report_pages")),
        },
